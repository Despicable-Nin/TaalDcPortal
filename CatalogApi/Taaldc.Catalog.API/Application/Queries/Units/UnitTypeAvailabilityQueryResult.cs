...
public class UnitTypeAvailabilityQueryResult
{
    ...
    [JsonPropertyName("unit_type_code")] public string UnitTypeCode { get; set; }

    [JsonPropertyName("unit_type")] public string UnitType { get; set; }

    [JsonPropertyName("min_floor_area")] public double MinFloorArea { get; set; }

    [JsonPropertyName("max_floor_area")] public double MaxFloorArea { get; set; }
